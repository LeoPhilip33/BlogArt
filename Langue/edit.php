<?php
  ...
  $sql = 'SELECT * FROM langue WHERE NumLang=:id'; // Tout sélectionner à propos de la table langue ou NumLang=:id
...
<div class="container">
  <div class="card mt-5">
    <div class="card-header">
      <h2>Mettre à jour la langue : <?= $person->Lib1Lang; ?> ? </h2> <!-- Récupération de Lib1Lang et affichage -->
    </div>
    <div class="card-body">
